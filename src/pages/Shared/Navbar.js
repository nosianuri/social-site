  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <li className='hover:bg-[#FD5D14]' style={({ isActive }) => ({ 
                            color: isActive ? 'greenyellow' : 'white' })}><NavLink to='/'>Home</NavLink></li>
      <li className='hover:bg-[#FD5D14]' style={({ isActive }) => ({ 
                            color: isActive ? 'greenyellow' : 'white' })}><NavLink to='/about'>About Us</NavLink></li>
      <li className='hover:bg-[#FD5D14]' style={({ isActive }) => ({ 
                            color: isActive ? 'greenyellow' : 'white' })}><NavLink to='contact'>Contact Us</NavLink></li>
      <li className='hover:bg-[#FD5D14]' style={({ isActive }) => ({ 
                            color: isActive ? 'greenyellow' : 'white' })}><NavLink to='/service'>Our Service</NavLink></li>
      <li className='hover:bg-[#FD5D14]' style={({ isActive }) => ({ 
                            color: isActive ? 'greenyellow' : 'white' })}><NavLink to='/privacy'>Privacy Policy</NavLink></li>
        <li tabindex="0">
